        ...
        >
          <div className="container-fluid container-xl">
            ...
            <div className="d-block d-lg-none">
                 ...
                 {
                    user?._id ? (
                      <button className='border-0 bg-transparent' onClick={handleLogout}><i class="fa-solid  fa-circle-left fa-lg pt-3 px-2  text-success border-0"></i></button>
                    )
                    :(

                      <Link to='/signin'> <i className="fa-solid fa-right-to-bracket pt-3 px-2  text-success"></i></Link>
                    )
                  } 
                 </span>
                  <i className="fa-solid fa-cart-shopping p-3 text-success"></i>
                  <Link><i class="fa-regular fa-user text-success pt-3 px-2" ></i></Link>
                </div>
            <div
              ...
              <ul className="navbar-nav  navbar-nav01 justify-content-center flex-grow-1 text-uppercase point12px fwbold mt-2">
                ...
                <div className="flex-nowrap d-none d-md-block">
                 ...
                 <span>
                 {
                  ...
                  <Link to="/"><i className="fa-solid fa-cart-shopping pt-3 px-2  text-success"></i></Link>
                 <Link>
               
                 <i class="fa-regular fa-user text-success pt-3 px-2" ></i></Link>
